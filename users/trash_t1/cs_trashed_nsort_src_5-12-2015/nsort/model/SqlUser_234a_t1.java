...
public class SqlUser_234a_t1 {
	...
	private final static String queryPullTestSessionIDScopeIdentity = "SELECT IDENT_CURRENT('TestSessions') as [Test Session ID];";
    ...
    public boolean isUserAccessAdmin(String username)
    {
    	...
    	try {
			...
			while (rs.next())
			{
				...
				if (role.equalsIgnoreCase(adminAccessRole)) return true; else return false;
		}
		catch (SQLException e)
		{
			System.err.println("Got an exception! ");
